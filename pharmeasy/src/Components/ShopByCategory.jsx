...
const ShopByCategory = () => {
 const{handleClick,isModalVisible, setIsModalVisibles}=useContext(AppContext);

  return (
    <div>
   <Box display="flex" justifyContent="flex-start" w="90%"   margin="auto"  marginTop="300px" onClick={()=>handleClick}>
   <Heading as='h3' size='lg'>Shop by Categories</Heading>
   </Box>
    
    
 <SimpleGrid columns={[1,2,6,8]} spacing={10}  w='90%' margin="auto"  marginTop="20px">
    <Box w='150px' h='150px' border="0.5px" borderRadius="10px" boxShadow='xs' bg="white"><Link to="/covidessential">
    <Stack spacing='24px'>
  ...
  <Box w='150px' h='150px' boxShadow='xs' borderRadius="10px" ><Link to="/devices"  bg="white">
     <Stack spacing='24px' >
 ...
 <Box w='150px' h='150px'boxShadow='xs' borderRadius="10px" bg="white" >
 <Link to="/healthfood" >
     <Stack spacing='24px'>
  ...
  <Box w='150px' h='150px'boxShadow='xs'borderRadius="10px" bg="white" ><Link to="/skincare"  >
    <Stack spacing='24px'>
